...
var Download = function(data) {
  ...
  var update_current_file_status = function(file_status){
  ...
  var sequence = {
    ...
    'start':{
      ...
      handle:function( matches ){
        ...
        update_current_file_status("starting");
      }
    },
    'download':{
      ...
      handle:function( matches ){
        ...
        that.eta = matches[4];
        update_current_file_status("downloading");
      }
    },
    'downloaded':{
      ...
      handle:function( matches ){
        ...
        that.eta = matches[2];
        update_current_file_status("downloaded");
      }
    },
    'already_downloaded':{
